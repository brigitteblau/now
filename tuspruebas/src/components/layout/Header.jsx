      ...
      <div className="header">
        <div className="header-content">
          ...
          <div className="selects">
            <select className="colegios">
              <option disabled> Colegios</option>
              <option value="colegio1">Colegio 1</option>
              <option value="colegio2">Colegio 2</option>
              <option value="colegio3">Colegio 3</option>
            </select>
            <select className="materias">
              <option value="">Materias</option>
              <option value="mat1">Materia 1</option>
              <option value="mat2">Materia 2</option>
              <option value="mat3">Materia 3</option>
            </select>
          </div>
        </div>
